...
class Full_map:
    def __init__(self, file_path, pixel_size=50., cadence=7.68):
        """
        Inputs:
    ...
    def distancetime(self, slit_coords, time_range=[0, 237], plot=False,
                     savefig=None):
        """
        Distances in pixels
    ...
    def find_boundaries(self, slit_coords, time_range=[0, 237],
        ...
        for i, t in enumerate(time_vals):
            t = int(t)
            params = gf.gauss_fit(-intensity1[t], p0=p0, retrn="pos_half_max")
    ...
    def animate(self, time_range=None, slit_coords=None, interval=200,
        ...
        im = plt.imshow(self.total_maps[time_range[0]][0].data, aspect='auto',
                        interpolation=None, animated=True, origin='lower')

        def updatefig(i):
            image_data = self.total_maps[time_range[0] + i][0].data
