...
def gauss_fit(data, p0=[0.5, 45., 10., -1.1], output="params"):
    """
    ...
    Inputs:
        ...
        output = 'params'       ---> return list of least squares params,
    ...
    if output == "params":
        ...
        raise ValueError("output must be 'params', 'func', or 'pos_half_max'")
