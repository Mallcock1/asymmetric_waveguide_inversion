...
def distancetime(xfinal=slit_coords_x[0], xinitial=slit_coords_x[1], 
                 yfinal=slit_coords_y[0], yinitial=slit_coords_y[1],
                 getintens=False, get_slice=False, frame_to_slice=0):
...
#    from astroML.plotting import setup_text_plots
    ...
    if getintens == True:
        ...
        global space
        space = np.linspace(0, num*50., len(intensity1[0])) # multiply by 0.428 instead to convert into Mm
